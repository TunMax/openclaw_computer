...
#### 2026-03-25
1. OpenClaw 升级到最新 2026.3.23-2 版本
...
4. OpenClaw 升级到最新 2026.3.23 版本
5. Chrome 浏览器升级到最新 146.0.7680.164 版本

#### 2026-03-22
1. 修复 `openclaw.json` 存在语法错误导致插件无法正常安装的问题
2. Chrome 浏览器升级到最新 146.0.7680.153 版本
...
2. OpenClaw 升级到最新 2026.3.13 版本
3. Chrome 浏览器升级到最新 146.0.7680.80 版本

#### 2026-03-14
1. 优化容器启动流程，避免因 openclaw 配置错误导致容器关闭，进而无法进入桌面环境排查问题

#### 2026-03-13
1. OpenClaw 升级到最新 2026.3.12 版本
